...
#    output:
#        output = os.path.join(OUTDIR, Label + "_codons.SA.FilterOutliers.fasta.cluster.json")
#    shell:
...
#   output:
#       output = os.path.join(OUTDIR, Label + "_codons.SA.FilterOutliers.fasta.cluster.fasta")
#   shell:
